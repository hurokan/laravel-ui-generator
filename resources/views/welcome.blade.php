...
<header class="bd-header bg-dark py-2 d-flex">
    <div class="px-3 py-2 text-bg-dark">
        <div class="container">
            <h1 class="d-flex align-items-center fs-4 text-white mb-0 ms-3">
                <img src="http://rokan.webasetech.com/wp-content/uploads/2022/12/passport_size_image.jpg" width="38"
                     height="30" class="me-3" alt="Bootstrap">
                Documents
            </h1>
        </div>
    </div>
    <div class="px-3 py-2">
        <div class="container d-flex flex-wrap justify-content-center">
            <form class="col-12 col-lg-auto mb-2 mb-lg-0 me-2" role="search">
